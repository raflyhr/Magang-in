      ...
      <div className={styles.mainGrid}>
        <div className={styles.section}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            <Link to="/admin/users" style={{ padding: '12px 20px', background: '#eef2ff', color: '#6366f1', borderRadius: '10px', textDecoration: 'none', fontWeight: 600, fontSize: '14px' }}>
              Kelola User
            </Link>
            <Link to="/admin/verifikasi" style={{ padding: '12px 20px', background: '#fff7ed', color: '#f97316', borderRadius: '10px', textDecoration: 'none', fontWeight: 600, fontSize: '14px' }}>
              Verifikasi Mitra
            </Link>
            <Link to="/admin/lowongan" style={{ padding: '12px 20px', background: '#f0f9ff', color: '#0ea5e9', borderRadius: '10px', textDecoration: 'none', fontWeight: 600, fontSize: '14px' }}>
              Kelola Lowongan
            </Link>
          </div>
        </div>
